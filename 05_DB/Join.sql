...
-- 순서는 앞에서부터가 맞는것....같아. JOIN 은 보통 두개 이상으로는 잘 안쓴대. 생각하기 복잡한가봐.
...
SELECT * FROM ACADEMY_A A RIGHT JOIN ACADEMY_B B ON A.STUDENT_NO = B.STUDENT_NO FULL OUTER JOIN ACADEMY_C C ON A.STUDENT_NO = C.STUDENT_NO;
